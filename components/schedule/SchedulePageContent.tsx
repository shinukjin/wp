      ...
      <div className="flex-1 min-w-0">
        <div className="mb-3 flex flex-col sm:flex-row sm:items-center gap-2">
          ...
          <input
            ...
            className="w-full sm:max-w-xs px-3 py-2 sm:py-1.5 text-sm border border-slate-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder:text-slate-400"
          />
        </div>
        <TravelScheduleTable
